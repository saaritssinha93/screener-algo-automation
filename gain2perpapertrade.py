...
shares = [
    ...
    'ASIANHOTNR', 'ASTERDM', 'AUROPHARMA', 'AXISBANK', 'BAMN ', 
    'BALAMINES', 'BALRAMCHIN', 'BANCOINDIA', 'BASF', 'BATAINDIA',
    'BAYERCROP', 'BDL', 'BEL', 'BEML',
    'BERGEPAINT', 'BFUTILITIE', 'BGRENERGY', 'BHAGERIA-BE', 'BHARATGEAR',
    ...
    'MAZDOCK', 'MBAPL', 'UNITDSPR', 'MINDACORP', 'MINDAIND',
